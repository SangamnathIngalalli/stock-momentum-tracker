...
// Note: Using the exact filename with en-dash found during investigation
const SOURCE_FILE = `C:\\Users\\Administrator\\OneDrive\\Swing Trading\\screener\\Quality Growth Pullback – Positional.xlsx`;
const TODAY_CSV = `C:\\Users\\Administrator\\OneDrive\\check Swing trading\\today_price.csv`;

test('update Quality Growth Pullback tracker', async () => {
